export default function Terms() {
  return (
    <div className="mx-auto max-w-[1300px] px-[10px] privacy-content">
      <h1>RootFi Terms of Service</h1>

      <p>
        <em>Last modified: September 30, 2025</em>
      </p>

      <p>
        These Terms of Service (the "Agreement") explain the terms and
        conditions by which you may access and use <strong>rootfi.org</strong>,{" "}
        <strong>app.rootfi.org</strong>, and any subdomains associated with the
        Website (collectively, the "Website"). You must read this Agreement
        carefully as it governs your use of the Website. By accessing or using
        the Website, you signify that you have read, understand, and agree to be
        bound by this Agreement in its entirety. If you do not agree, you are
        not authorized to access or use the Website and should not use the
        Website.
      </p>
      ...
      <p>
        ...
        public blockchains, including but not limited to Ethereum, BNB Chain,
        Base, Arbitrum and Bitcoin, that allow users to interact with digital
        assets ("the RootFi protocol" or the "Protocol"), among other services.
        The Website is one, but not the exclusive, means of accessing the
        Protocol.
      </p>

      <p>
        To access the Website, you must use either non-custodial wallet software
        or third-party authentication providers, which allow you to interact
        with public blockchains. Your relationship with these providers is
        governed by the applicable terms of service of those third parties, not
        this Agreement. These services are not operated by, maintained by, or
        affiliated with us, and we do not have custody or control over any user
        assets and have no ability to retrieve or transfer their contents. By
        connecting to our Website, you agree to be bound by this Agreement and
        all of the terms incorporated herein by reference.
      </p>

      <h2>2. Modification of this Agreement</h2>
      <p>
        ...
        <strong>https://rootfi.org/terms</strong>. All modifications will be
        effective immediately upon posting, and your continued accessing or use
        of the Website will serve as confirmation of your acceptance of those
        modifications.{" "}
        <strong>
          We are under no obligation to notify you of any modifications to this
          Agreement through any other means.
        </strong>{" "}
        If you do not agree with any modifications to this Agreement, you must
        immediately stop accessing and using the Website.
      </p>

      <h2>3. Website for Accessing Protocol</h2>
      <p>
        The Website is distinct from the underlying decentralized protocols and
        is one, but not the exclusive, means of accessing digital asset
        operations. These operations are executed through existing decentralized
        protocols and public blockchains, which RootFi does not control or
        operate. By using the Website, you understand that you are not buying or
        selling digital assets from us and that we do not control transaction
        execution or asset management. All operations are processed through
        independent decentralized networks, where RootFi serves solely as an
        interface provider. When users participate in any operations, associated
        fees accrue to the respective decentralized protocols and their
        participants. As a general matter, the RootFi team does not participate
        in asset management or transaction processing, which are handled by
        independent third parties.
      </p>

      <h2>4. Eligibility</h2>
      <p>
        The RootFi website is for informational purposes only. RootFi is not
        part of any transaction on blockchain networks; we do not have
        possession, custody, or control over any crypto assets or users' funds.
        You understand that when you interact with decentralized protocols, you
        always retain control over your crypto assets.
      </p>

      <p>
        As a condition to accessing or using the Website, you represent and
        warrant that:
      </p>
      <ul>
        <li>
          You are of legal age in your jurisdiction and have the legal capacity
          to enter into these Terms, or if you represent an entity, you have the
          legal authority to accept these Terms on that entity's behalf;
        </li>
        <li>
          You are not a resident, national, or agent of any restricted
          territories subject to comprehensive sanctions or embargoes, including
          but not limited to jurisdictions with extensive regulatory
          restrictions on digital asset transactions;
        </li>
        <li>
        ...
        <li>
          You are not listed on any sanctions lists maintained by the United
        ...
        <li>
          Your access does not violate any applicable laws, regulations, or
          sanctions;
        </li>
        <li>
          You will fully comply with all applicable laws and regulations, and
          will not access or use the Website to conduct, promote, or facilitate
      ...
      <p>
        RootFi owns all intellectual property and other rights in the Website
      ...
      <p>
        By using the Website, you grant us a worldwide, non-exclusive,
        sublicensable, royalty-free license to use, copy, modify, and display
        any content, including but not limited to text, materials,
        communications, comments, feedback, suggestions, ideas, concepts,
        questions, or data that you post on or through the Website for our
      ...
      <p>
        ...
        grant the rights granted herein for any content that you post on or
        through the Website. You represent and warrant that such content does
      ...
      <ul>
        ...
        <li>
          <strong>Cyberattack.</strong> Activity that seeks to interfere with or
        ...
        <li>
          ...
          tactics commonly known as "rug pulls", pumping and dumping, and wash
          trading.
        </li>
        <li>
          <strong>Securities and Derivatives Violations.</strong> Activity that
        ...
        <li>
          <strong>Data Mining or Scraping.</strong> Activity that involves data
          mining, robots, scraping, or similar data gathering or extraction
          methods of content or information from the Website.
        </li>
        <li>
        ...
        <li>
          <strong>Any Other Unlawful Conduct.</strong> Activity that violates
          any applicable law, rule, or regulation of any relevant jurisdiction.
        </li>
      </ul>

      <h3>6.2 Non-Custodial and No Fiduciary Duties</h3>
      <p>
      ...
      <h3>6.3 Compliance and Tax Obligations</h3>
      <p>
      ...
      <p>
        ...
        apply to any transactions you initiate or receive and, if so, to report
        and/or remit the correct tax to the appropriate tax authority.
      </p>

      <h3>6.4 Release of Claims</h3>
      <p>
      ...
      <p>
        ...
        tokens which are transacted on RootFi.
      </p>
      ...
      <p>
        ...
        and acknowledge and accept the risk that you may mistakenly transact
        with those or other tokens. So-called stablecoins may not be as stable
        as they purport to be, may not be fully or adequately collateralized,
      ...
      <p>
        ...
        You further acknowledge and accept the risk of interacting with
        decentralized protocols under high volatility conditions, which may
        result in significant price slippage and higher costs.
      </p>
      ...
      <p>
        ...
        Protocol are generally managed in a community-driven way through
        discussions, proposals, and contributions from independent developers
        and users. No developer or entity involved in creating the Protocol will
      ...
      <h3>7.3 Non-Solicitation; No Investment Advice</h3>
      <p>
        You agree and understand that: (a) all transactions you submit through
        the Website are considered unsolicited, which means that they are solely
        initiated by you; (b) you have not received any investment advice from
        us in connection with any transactions; and (c) we do not conduct a
        suitability review of any transactions you submit.
      </p>
      ...
      <p>
        ...
        explorer or token lists. We may also provide warning labels for certain
        tokens. The provision of informational materials does not make
        transactions in those tokens solicited; we are not attempting to induce
        you to make any purchase as a result of information provided. All such
        information provided by the Website is for informational purposes only
        and should not be construed as investment advice or a recommendation
        that a particular token is a safe or sound investment. You should not
        take, or refrain from taking, any action based on any information
        contained in the Website. By providing token information for your
        ...
        or related transaction is appropriate for you based on your personal
      ...
      <p>
        You agree that this Agreement and any Dispute between you and us shall
        be governed by the laws of a jurisdiction determined by RootFi, without
        regard to principles of conflict of laws. You further agree that the
        Website shall be deemed to be based solely in the jurisdiction chosen by
        RootFi, and that although the Website may be available in other
        jurisdictions, its availability does not give rise to general or
        specific personal jurisdiction in any forum outside the chosen
        jurisdiction. Any arbitration conducted pursuant to this Agreement shall
        follow internationally recognized arbitration rules. You agree that the
        courts of the chosen jurisdiction are the proper forum for any appeals
        of an arbitration award or for court proceedings in the event that this
      ...
      <p>
        ...
        must contact us by sending an email to <strong>legal@rootfi.org</strong>{" "}
      ...
      <p>
        ...
        settled by arbitration in a jurisdiction determined by RootFi. The
        arbitration shall be confidential, conducted by a single arbitrator, and
        follow internationally recognized arbitration rules.
      </p>

      <h3>10.3 Class Action and Jury Trial Waiver</h3>
      <p>
      ...
      <p>
        ...
        like Ethereum. As a result, we do not (and cannot) guarantee market best
        pricing or best execution through the Website or any features available
        on the Website. Any references in the Website to potential returns,
        market conditions, or performance do not constitute a representation or
        warranty about pricing available through the Website, on the Protocol,
        or elsewhere.
      </p>
      ...
      <p>
        ...
        <strong>legal@rootfi.org</strong>.
      </p>
    </div>
  );
}
